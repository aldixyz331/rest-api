...
router.get('/cecan/china', async (req, res, next) => {
    ...
    try {
        ...
        res.status(500).json({ status: 500, message: 'Error fetching image' });
    }
})
...
router.get('/nsfw/ass', async (req, res, next) => {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/danzzcoding/data-danzzapi.xyz/main/nsfw/ass.json`))
        ...
        .then(data => {
            var result = data;
            var result = data[Math.floor(Math.random() * data.length)];
            axios.get(result.url, { responseType: 'arraybuffer' })
                .then(response => {
                    res.set('Content-Type', 'image/png');
                    res.send(response.data);
                    limitAdd(apikey);
...
router.get('/islam/tahlil', async (req, res, next) => {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/ryuzetsuofficial/My-SQL-Results/master/data/dataTahlil.json`))
        .then(response => response.json())
        .then(data => {
            var result = data;
            res.json({
...
router.get('/islam/wirid', async (req, res, next) => {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/ryuzetsuofficial/My-SQL-Results/master/data/dataWirid.json`))
        .then(response => response.json())
        .then(data => {
            var result = data;
            res.json({
...
router.get('/islam/ayatkursi', async (req, res, next) => {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/ryuzetsuofficial/My-SQL-Results/master/data/dataAyatKursi.json`))
        .then(response => response.json())
        .then(data => {
            var result = data;
            res.json({
...
router.get('/islam/doaharian', async (req, res, next) => {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/ryuzetsuofficial/My-SQL-Results/master/data/dataDoaHarian.json`))
        .then(response => response.json())
        .then(data => {
            var result = data;
            res.json({
...
router.get('/islam/bacaanshalat', async (req, res, next) => {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/ryuzetsuofficial/My-SQL-Results/master/data/dataBacaanShalat.json`))
        .then(response => response.json())
        .then(data => {
            var result = data;
            res.json({
...
router.get('/islam/niatshalat', async (req, res, next) => {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/ryuzetsuofficial/My-SQL-Results/master/data/dataNiatShalat.json`))
        .then(response => response.json())
        .then(data => {
            var result = data;
            res.json({
...
router.get('/islam/kisahnabi', async (req, res, next) => {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/ryuzetsuofficial/My-SQL-Results/master/data/dataKisahNabi.json`))
        .then(response => response.json())
        .then(data => {
            var result = data;
            res.json({
...
router.get('/islam/asmaulhusna', async (req, res, next) => {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/ryuzetsuofficial/My-SQL-Results/master/data/dataAsmaulHusna.json`))
        .then(response => response.json())
        .then(data => {
            var result = data;
            res.json({
...
router.get('/islam/niatsubuh', async (req, res, next) => {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/ryuzetsuofficial/My-SQL-Results/master/data/NiatShubuh.json`))
        .then(response => response.json())
        .then(data => {
            var result = data;
            res.json({
...
router.get('/islam/niatzuhur', async (req, res, next) => {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/ryuzetsuofficial/My-SQL-Results/master/data/NiatDzuhur.json`))
        .then(response => response.json())
        .then(data => {
            var result = data;
            res.json({
...
router.get('/islam/niatmagrib', async (req, res, next) => {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/ryuzetsuofficial/My-SQL-Results/master/data/NiatMaghrib.json`))
        .then(response => response.json())
        .then(data => {
            var result = data;
            res.json({
...
router.get('/islam/niatisya', async (req, res, next) => {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/ryuzetsuofficial/My-SQL-Results/main/data/NiatIsya.json`))
        .then(response => response.json())
        .then(data => {
            var result = data;
            res.json({
...
router.get('/islam/niatashar', async (req, res, next) => {
    ...
    fetch(encodeURI(`https://raw.githubusercontent.com/ryuzetsuofficial/My-SQL-Results/master/data/NiatAshar.json`))
        .then(response => response.json())
        .then(data => {
            var result = data;
            res.json({
