    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Welcome to Api RyuZetsu - an awesome REST API!</h3>
            <p>
...
If you have any problem, please contact via <span
            ...
            <span style="display: block;"><br>Regards,<br>RyuZetsu</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"RyuZetsu" <no-reply@gmail.com>',
        to: email,
        subject: `Verify Email - Api RyuZetsu`,
        html: inboxGmail,
      };
